    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                />
                <Text style={styles.confirmText}>Success, Hub Added!</Text>
            </View>

            <Pressable
                style={styles.button}
                onPress={() => {
                    navigation.navigate('HubMenu', { email }); // Navigate to HubMenu
                }}

            >
                <Text style={styles.buttonText}>See Hubs</Text>
            </Pressable>
        </View>
    );
};
